package net.z0kai.kkrefreshlayout_demo.headerview.vertical;
...
public class BuDuoHeaderView extends RelativeLayout implements IHeaderView {
    ...
    public BuDuoHeaderView(Context context) {
        this(context, null);
    }

    public BuDuoHeaderView(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(getContext()).inflate(R.layout.kk_rl_buduo_header_view, this);
